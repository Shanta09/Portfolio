 ...
 */
!function(a)
	{"use strict";a("a.page-scroll").bind("click",function(e)
		{var o=a(this);a("html, body").stop().animate(
			...
			a(".navbar-collapse ul li a:not(.dropdown-toggle)").click(function()
				...
				{duration:600,scale:.3,distance:"0px"},200),
				...
				{delegate:"a",type:"image",tLoading:"Loading image #%curr%...",mainClass:"mfp-img-mobile",gallery:{enabled:!0,navigateByImgClick:!0,preload:[0,1]},
				image:{tError:'<a href="%url%">The image #%curr%</a> could not be loaded.'}})}(jQuery);
